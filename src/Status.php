        ...
        <div id="newss-pipeline-live" style="margin:8px 0 20px 0;padding:14px 18px;border:1px solid #dcdcde;border-left:4px solid #999;background:#f6f7f7;max-width:1280px">
            ...
            <div style="display:flex;justify-content:space-between;align-items:center;margin-top:8px;gap:10px;flex-wrap:wrap">
                ...
                <div style="display:flex;gap:6px;flex-wrap:wrap">
                    ...
                    <form method="post" action="<?php echo esc_url($cleanupUrl); ?>" style="margin:0">
                        <input type="hidden" name="action" value="newss_clear_all_jobs">
                        <?php wp_nonce_field('newss_clear_all_jobs'); ?>
                        <button type="submit" class="button button-small button-link-delete"
                                onclick="return confirm('WIRKLICH ALLE Newss-Jobs loeschen?\n\nDas entfernt die komplette Queue: pending + in-progress + failed + complete inkl. aller Logs.\n\nKanaele bleiben, existierende Posts bleiben. Beim naechsten Channel-Poll werden neue Jobs enqueued.\n\nFortfahren?');">
                            Alles löschen
                        </button>
                    </form>
                </div>
